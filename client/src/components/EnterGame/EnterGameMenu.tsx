    ...
    <Slider isOpen={isOpen} onClose={onClose} height="250px">
      <div className="relative z-10 flex items-center justify-center h-full">
        ...
        <div className="modal-content bg-[#18171C] rounded-[15px] px-[30px]">
          <button
            className="menu-button relative flex justify-center items-center"
            onClick={() => openModal("createPublic")}
          >
            <img
              src={plusIcon}
              alt="Create"
              className="absolute left-[20px] top-[50%] -translate-y-[50%] w-[26px] h-[26px]"
            />
          ...
          >
            <img
              src={partyIcon}
              alt="Join"
              className="absolute left-[20px] top-[50%] -translate-y-[50%] w-[28px] h-[28px]"
            />
