...
const GameTable: React.FC<GameTableProps> = ({
  ...
  const containerStyle: React.CSSProperties = {
    ...
    boxShadow:
      "0px 4px 4px 0px rgba(0, 0, 0, 0.25), 0px 5.5px 10px 0px rgba(0, 0, 0, 0.25), 0px 0px 4px 11px rgba(0, 0, 0, 0.05), 0px -1px 4px 3px rgba(0, 0, 0, 0.25), 0px 0px 5.5px 10px rgba(0, 0, 0, 0.05)",
  };
  ...
  return (
    <div style={containerStyle} className={tableClasses}>
      ...
      {/* Надпись "налог 5%" */}
      <div style={taxStyle}>{t("tax_5_percent")}</div>
